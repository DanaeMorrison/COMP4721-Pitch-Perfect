...
public class Model {
    ...
    private void initializeUnit2() {
        ...
        unit2Lessons[0] = new Lesson(0, "Lesson 1", "Treble Clef Note Identification with Sharps", u2_l1);
        ...
        unit2Lessons[1] = new Lesson(1, "Lesson 2", "Bass Clef Note Identification with Sharps", u2_l2);
        ...
        unit2Lessons[2] = new Lesson(2, "Lesson 3", "Mixed Clef Note Identification with Sharps", u2_l3);
        ...
        unit2Drills[0] = new Drill(0, "Drill 1", "Mixed Clef Drill with Sharps", u2_d1, 180);
        drills.add(unit2Drills[0]);

        Unit unit2 = new Unit(3, "Unit 3", "Note Identification with Sharps", unit2Lessons, unit2Drills);
        units.add(unit2);
    }
    ...
    private void initializeUnit3() {
        ...
        u3_l1[7] = new Flashcard(7, new int[] { 60, 64, 67 }, new int[] { 1, 5, 8 }, 'B', 'L'); // C Major
        u3_l1[8] = new Flashcard(8, new int[] { 62, 66, 69 }, new int[] { 2, 6, 9 }, 'B', 'L'); // D Major
        u3_l1[9] = new Flashcard(9, new int[] { 64, 68, 71 }, new int[] { 4, 8, 11 }, 'B', 'L'); // E Major
        u3_l1[10] = new Flashcard(10, new int[] { 65, 69, 72 }, new int[] { 5, 9, 1 }, 'B', 'L'); // F Major
        u3_l1[11] = new Flashcard(11, new int[] { 67, 71, 74 }, new int[] { 8, 11, 2 }, 'B', 'L'); // G Major
        u3_l1[12] = new Flashcard(12, new int[] { 69, 73, 76 }, new int[] { 9, 1, 4 }, 'B', 'L'); // A Major
        u3_l1[13] = new Flashcard(13, new int[] { 71, 75, 78 }, new int[] { 11, 3, 6 }, 'B', 'L'); // B Major
        u3_l1[14] = new Flashcard(14, new int[] { 60, 64, 67 }, new int[] { 1, 5, 8 }, 'T', 'R'); // C Major

        unit3Lessons[0] = new Lesson(0, "Lesson 1", "Major Chords Identification", u3_l1);
        ...
        u3_l2[7] = new Flashcard(7, new int[] { 60, 63, 67 }, new int[] { 1, 4, 8 }, 'B', 'L'); // C Minor
        u3_l2[8] = new Flashcard(8, new int[] { 62, 65, 69 }, new int[] { 2, 5, 9 }, 'B', 'L'); // D Minor
        u3_l2[9] = new Flashcard(9, new int[] { 64, 67, 71 }, new int[] { 4, 7, 11 }, 'B', 'L'); // E Minor
        u3_l2[10] = new Flashcard(10, new int[] { 65, 68, 72 }, new int[] { 5, 8, 1 }, 'B', 'L'); // F Minor
        u3_l2[11] = new Flashcard(11, new int[] { 67, 70, 74 }, new int[] { 8, 10, 2 }, 'B', 'L'); // G Minor
        u3_l2[12] = new Flashcard(12, new int[] { 69, 72, 76 }, new int[] { 9, 12, 4 }, 'B', 'L'); // A Minor
        u3_l2[13] = new Flashcard(13, new int[] { 71, 74, 78 }, new int[] { 11, 2, 6 }, 'B', 'L'); // B Minor
        u3_l2[14] = new Flashcard(14, new int[] { 60, 63, 67 }, new int[] { 1, 4, 8 }, 'T', 'R'); // C Minor

        unit3Lessons[1] = new Lesson(1, "Lesson 2", "Minor Chords Identification", u3_l2);
        ...
        unit3Lessons[2] = new Lesson(2, "Lesson 3", "Mixed Chords Identification", u3_l3);
        lessons.add(unit3Lessons[2]);

        Unit unit3 = new Unit(3, "Unit 3", "Chord Identification", unit3Lessons, null);
        units.add(unit3);
    }
    ...
    private void initializeUnit4() {
        ...
        u4_l1[11] = new Flashcard(11, new int[] { 74, 79, 83 }, new int[] { 14, 19, 22 }, 'T', 'R'); // G Minor 2nd Inv
        ...
        unit4Lessons[0] = new Lesson(10, "Lesson 1", "Triad Inversions", u4_l1);
        ...
        u4_l2[3] = new Flashcard(3, new int[] { 67, 71, 74, 77 }, new int[] { 7, 11, 14, 17 }, 'T', 'R'); // G Dominant
                                                                                                          // 7th
        u4_l2[4] = new Flashcard(4, new int[] { 59, 62, 65, 69 }, new int[] { 11, 2, 5, 9 }, 'T', 'R'); // B Diminished
                                                                                                        // 7th
        ...
        u4_l2[10] = new Flashcard(10, new int[] { 67, 71, 74, 77 }, new int[] { 7, 11, 14, 17 }, 'T', 'R'); // G
                                                                                                            // Dominant
                                                                                                            // 7th
        u4_l2[11] = new Flashcard(11, new int[] { 59, 63, 66, 69 }, new int[] { 11, 3, 6, 9 }, 'T', 'R'); // B
                                                                                                          // Half-Diminished
                                                                                                          // 7th
        ...
        unit4Lessons[1] = new Lesson(11, "Lesson 2", "Root Position 7th Chords", u4_l2);
        ...
        unit4Lessons[2] = new Lesson(12, "Lesson 3", "Mixed Inversions and 7th Chords", u4_l3);
        ...
        unit4Drills[0] = new Drill(4, "Drill 1", "Inversions and 7th Chords Drill", u4_d1, 240);
