...
public class NoteMapping {
    ...
    public NoteMapping() {
        ...
        trebleClefCoordinates.put(61, new int[] { 615, 745, 528, 658 }); // C#4
        ...
        trebleClefCoordinates.put(63, new int[] { 615, 745, 496, 626 }); // D#4
        ...
        trebleClefCoordinates.put(66, new int[] { 615, 745, 432, 562 }); // F#4
        ...
        trebleClefCoordinates.put(68, new int[] { 615, 745, 400, 530 }); // G#4
        ...
        trebleClefCoordinates.put(70, new int[] { 615, 745, 368, 498 }); // A#4
        ...
        trebleClefCoordinates.put(73, new int[] { 615, 745, 304, 434 }); // C#5
        ...
        trebleClefCoordinates.put(75, new int[] { 615, 745, 272, 402 }); // D#5
        ...
        trebleClefCoordinates.put(78, new int[] { 615, 745, 208, 338 }); // F#5
        ...
        trebleClefCoordinates.put(80, new int[] { 615, 745, 176, 306 }); // G#5
        ...
        trebleClefCoordinates.put(82, new int[] { 615, 745, 144, 274 }); // A#5
        ...
        bassClefCoordinates.put(42, new int[] { 615, 745, 496, 626 }); // F#2
        ...
        bassClefCoordinates.put(44, new int[] { 615, 745, 464, 594 }); // G#2
        ...
        bassClefCoordinates.put(46, new int[] { 615, 745, 432, 562 }); // A#2
        ...
        bassClefCoordinates.put(49, new int[] { 615, 745, 368, 498 }); // C#3
        ...
        bassClefCoordinates.put(51, new int[] { 615, 745, 336, 466 }); // D#3
        ...
        bassClefCoordinates.put(54, new int[] { 615, 745, 272, 402 }); // F#3
        ...
        bassClefCoordinates.put(56, new int[] { 615, 745, 240, 370 }); // G#3
        ...
        bassClefCoordinates.put(58, new int[] { 615, 745, 208, 338 }); // A#3
        ...
        bassClefCoordinates.put(61, new int[] { 615, 745, 144, 274 }); // C#4
